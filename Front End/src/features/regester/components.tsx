...
export const Header  = () => {
  ...
  return (
    <Box>
      ...
      <Box margin="24px" display="flex" alignItems="center" justifyContent="center"  >{loginState.error?.length ? <Typography fontWeight="bold" textTransform="capitalize" color="secondary.main" textAlign="center" variant="h4" ><WarningIcon/>     {loginState.error} </Typography> : ""}</Box>
    </Box>
    )
}